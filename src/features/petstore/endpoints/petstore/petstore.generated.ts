...
export const getListPetsUrl = (params?: ListPetsParams,) => {
  ...
  return stringifiedParams.length > 0 ? `http://localhost:3000/pets?${stringifiedParams}` : `http://localhost:3000/pets`
}
...
export const showPetById = async (petId: string,
    testId: string, options?: RequestInit): Promise<showPetByIdResponse> => {
